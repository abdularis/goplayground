...
var file_user_service_proto_rawDesc = []byte{
	...
	0x72, 0x6f, 0x74, 0x6f, 0x12, 0x07, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x22, 0x2b, 0x0a,
	...
	0x28, 0x09, 0x52, 0x06, 0x75, 0x73, 0x65, 0x72, 0x49, 0x44, 0x22, 0x6a, 0x0a, 0x0a, 0x55, 0x73,
	...
	,
...
var file_user_service_proto_goTypes = []interface{}{
	(*UserDetailRequest)(nil), // 0: service.UserDetailRequest
	(*UserDetail)(nil),        // 1: service.UserDetail
}
var file_user_service_proto_depIdxs = []int32{
	0, // 0: service.UserService.GetUserDetail:input_type -> service.UserDetailRequest
	1, // 1: service.UserService.GetUserDetail:output_type -> service.UserDetail
...
type UserServiceClient interface {
	GetUserDetail(ctx context.Context, in *UserDetailRequest, opts ...grpc.CallOption) (*UserDetail, error)
}
...
func (c *userServiceClient) GetUserDetail(ctx context.Context, in *UserDetailRequest, opts ...grpc.CallOption) (*UserDetail, error) {
	out := new(UserDetail)
	err := c.cc.Invoke(ctx, "/service.UserService/GetUserDetail", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type UserServiceServer interface {
	GetUserDetail(context.Context, *UserDetailRequest) (*UserDetail, error)
}
...
func (*UnimplementedUserServiceServer) GetUserDetail(context.Context, *UserDetailRequest) (*UserDetail, error) {
...
func _UserService_GetUserDetail_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/service.UserService/GetUserDetail",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServiceServer).GetUserDetail(ctx, req.(*UserDetailRequest))
	}
